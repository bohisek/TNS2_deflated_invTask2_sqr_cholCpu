...
int main(void)
{
	...
	makeTNS2<<<2048,512>>>(kc, ks, kw, ksw, kse, kss, kww, ksee, ksse, dcc, dss, dww, params.Nx, params.Ny);
	...
	for (int miter=0; miter<params.steps; miter++) {
		...
		SpMVv2<<<1024,1024>>>(dz, kc, ks, kw, ksw, kse, kss, kww, ksee, ksse, dr, params.Nx, params.Ny);   // z = M^(-1)r (version 2)
